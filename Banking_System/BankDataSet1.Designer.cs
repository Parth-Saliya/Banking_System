...
namespace Banking_System {
    ...
    public partial class BankDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BranchDataTable : global::System.Data.TypedTableBase<BranchRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BranchRow AddBranchRow(string Branch_code, string Branch_Name, string Branch_Add) {
            ...
            private void InitClass() {
                ...
                this.columnBranch_Add.MaxLength = 50;
            }
...
namespace Banking_System.BankDataSet1TableAdapters {
    ...
    public partial class BranchTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Branch] WHERE (([Branch_id] = @Original_Branch_id) AND ((@IsNull_Branch_code = 1 AND [Branch_code] IS NULL) OR ([Branch_code] = @Original_Branch_code)) AND ((@IsNull_Branch_Name = 1 AND [Branch_Name] IS NULL) OR ([Branch_Name] = @Original_Branch_Name)) AND ((@IsNull_Branch_Add = 1 AND [Branch_Add] IS NULL) OR ([Branch_Add] = @Original_Branch_Add)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Branch_Add", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Branch_Add", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Branch] ([Branch_code], [Branch_Name], [Branch_Add]) VALUES (@" +
                "Branch_code, @Branch_Name, @Branch_Add);\r\nSELECT Branch_id, Branch_code, Branch_" +
                "Name, Branch_Add FROM Branch WHERE (Branch_id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Branch_Add", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Branch_Add", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Branch] SET [Branch_code] = @Branch_code, [Branch_Name] = @Branch_Name, [Branch_Add] = @Branch_Add WHERE (([Branch_id] = @Original_Branch_id) AND ((@IsNull_Branch_code = 1 AND [Branch_code] IS NULL) OR ([Branch_code] = @Original_Branch_code)) AND ((@IsNull_Branch_Name = 1 AND [Branch_Name] IS NULL) OR ([Branch_Name] = @Original_Branch_Name)) AND ((@IsNull_Branch_Add = 1 AND [Branch_Add] IS NULL) OR ([Branch_Add] = @Original_Branch_Add)));
SELECT Branch_id, Branch_code, Branch_Name, Branch_Add FROM Branch WHERE (Branch_id = @Branch_id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Branch_Add", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Branch_Add", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Branch_Add", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Branch_Add", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Branch_id, Branch_code, Branch_Name, Branch_Add FROM dbo.Branch";
        ...
        public virtual int Delete(int Original_Branch_id, string Original_Branch_code, string Original_Branch_Name, string Original_Branch_Add) {
            ...
            if ((Original_Branch_Add == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Branch_Add));
            }
        ...
        public virtual int Insert(string Branch_code, string Branch_Name, string Branch_Add) {
            if ((Branch_code == null)) {
        ...
        public virtual int Update(string Branch_code, string Branch_Name, string Branch_Add, int Original_Branch_id, string Original_Branch_code, string Original_Branch_Name, string Original_Branch_Add, int Branch_id) {
            if ((Branch_code == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Branch_code, string Branch_Name, string Branch_Add, int Original_Branch_id, string Original_Branch_code, string Original_Branch_Name, string Original_Branch_Add) {
            return this.Update(Branch_code, Branch_Name, Branch_Add, Original_Branch_id, Original_Branch_code, Original_Branch_Name, Original_Branch_Add, Original_Branch_id);
        }
    }
